...
function gameOver() {
    let i;
    for (i = 0; i < 9; i++) if (typeof game.chess[i] == 'undefined') break;
    if (i == 9) return 2;
    ...
    if (typeof game.chess[0] != "undefined" && game.chess[0] == game.chess[4] && game.chess[0] == game.chess[8]) return game.chess[0];
    if (typeof game.chess[2] != "undefined" && game.chess[2] == game.chess[4] == game.chess[6]) return game.chess[2];
